...
function wb$popWikibug()
{
  ...
  wb$popBugBoth("Википедия:Сообщения об ошибках", '\
    <div style="float:right;width:200px;padding:4px 10px;margin:2px 0px 0px 10px;font-size:90%;border:2px solid #900"><p>Пожалуйста, <strong>не\u00A0сообщайте</strong> об\u00A0ошибках в\u00A0стороннем программном обеспечении и на\u00A0сайтах, не\u00A0связанных с\u00A0Википедией (ошибки вашей операционной системы, сайтов <strong>«В\u00A0Контакте»</strong> или <strong>«Одноклассники.ru»</strong> и подобные будут проигнорированы).</p>\
    <p>Если вы не\u00A0нашли какой-либо информации в\u00A0Википедии\u00A0— это не\u00A0ошибка, запросы на\u00A0новые статьи вы можете оставить на\u00A0странице «<a href="' + link_tocreate + '">К\u00A0созданию</a>».</p></div>\
    <p style="margin-top:0px">Если вы заметили ошибку в\u00A0Википедии, пожалуйста, исправьте её самостоятельно, используемая на\u00A0этом сайте технология <a href="' + link_wiki + '">вики</a> позволяет это сделать. Не\u00A0смущайтесь, одно из\u00A0правил Википедии гласит: «<a href="' + link_bebold + '">Правьте смело</a>»! Если по\u00A0каким-либо причинам вы не\u00A0можете исправить ошибку самостоятельно, сообщите о\u00A0ней с\u00A0помощью данной формы.</p><p><strong>Если ошибка уже исправлена\u00A0— не\u00A0сообщайте о\u00A0ней.</strong></p><p>Не\u00A0оставляйте свою контактную информацию (телефон и/или электронный адрес), ответ на\u00A0сообщение будет дан только на\u00A0странице с\u00A0сообщениями и нигде больше.</p>\
